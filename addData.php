...
<head>
    ...
    <title>Tambah Data | NABILA COLECTION | CRUD</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">NABILA COLECTION | CRUD</a>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2">
                ...
                <p>Aplikasi ini dikembangkan untuk menggambangkan data mahasiswa mahasiswi Unisnu</p>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://instagram.com/bgzegran" target="_blank" style="color: #fff;">Muhammad hanif Khoirullah</a></p>
    </footer>
    <!-- Close Footer -->
