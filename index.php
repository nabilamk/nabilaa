...
<head>
    ...
    <title>NABILA COLECTION | CRUD</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Mahasiswa Mahasiswa Teknik</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2" id="about">
                ...
                <p>Devoloper Sanabila Aulia Rahmah Mk</p>
            </div>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class=" "></i> by <u style="color: #fff;">Sanabila Aulia Rahmah MK</u></p>
    </footer>
    <!-- Close Footer -->
